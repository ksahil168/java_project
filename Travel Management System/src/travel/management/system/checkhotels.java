...
public class checkhotels extends JFrame implements Runnable{
    ...
    JLabel caption; 
    public void run(){
        String[] text = new String[]{"JW MARRIOT HOTEL", "MANDARIN ORIENTAL HOTEL", "FOUR SEASON HOTEL", "RADDISONBLUE HOTEL", "CLASSIO HOTEL ", "THE BAY CLUD HOTEL", "BREEZE BLOW HOTEL", "THE TAJ HOTEL", "HAPPY MORNING MOTEL", "RIVER VIEW HOTEL"};
    ...
    checkhotels(){
       ...
       caption = new JLabel();
       caption.setBounds(150,500,1000,70);
